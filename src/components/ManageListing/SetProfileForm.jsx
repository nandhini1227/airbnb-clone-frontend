...
const validationSchema = Yup.object().shape({
  name: Yup.string(),
  image: Yup.mixed(),
  aboutHost: Yup.string().min(150, 'Minimum 150 characters')
});

const SetProfileForm = ({handleSaveCard3}) => {
      ...
      {({ values, errors, touched, setFieldValue }) => (
        <FormContainer>
          <Form >
            ...
            <Button type="submit" variant="contained"sx={{backgroundColor:'#ff385c', marginTop:'1rem', color: '#fffff'}} >
              Submit
            </Button>
          </Form>
        </FormContainer>
...
SetProfileForm.propTypes = {
  handleSaveCard3: PropTypes.func.isRequired,
};
